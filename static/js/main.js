  ...
  $.ajax({
    ...
    success: function(data) {
      if(data === "live") {
        ...
        $(".headsup").html('<a href="https://www.twitch.tv/loadingartist" target="_blank" rel="noopener noreferrer"><img src="/header-widgets/live.gif" alt="LIVE on Twitch!"></a>');
        $(".bottomsup").html('<a href="https://www.twitch.tv/loadingartist" target="_blank" rel="noopener noreferrer"><img src="/header-widgets/live.gif" alt="LIVE on Twitch!"></a>');
      }
    }
  });
